...
namespace SvxlinkManager.Application.Integration.Tests.SMC.RP
{
    ...
    {
        [Test]
        public async Task DeleteRadioProfilCommand_ShouldDeleteRadioProfil()
        {
            try
            {
                // Arrange
                ...
                var install = from id in CreateDefaultConfig()
                              ...
                              from radioProfil in RadioProfil.Create(radioProfilGuid, "RadioProfilToDelete", "145.500", "145.800", "1", "67", "88.5", "1", "1", "1", "1", "1")
                ...
                var command = new DeleteRadioProfilCommand(configGuid, radioProfilGuid);
