...
namespace SvxlinkManager.Infrastructure.Services
{
    ...
    public class IniService : IIniService
    {
        ...
        /// <code></code>
        /// </example>
        public virtual Validation<Error, Unit> ReplaceConfig(string filePath, Dictionary<string, Dictionary<string, string>> parameters)
        {
            try
            {
            ...
            {
                return Error.New("Erreur lors de la modification du fichier de configuration.", ex);
            }
