...
namespace Spotnik.Gui.Data
{
  ...
  public class ApplicationDbContext : IdentityDbContext
  {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      ...
      builder.Entity<Channel>().HasData(new Channel { Id = 3, Name = "French Open Network", CallSign= "(CH) HB9GXP2 H", Host= "serveur.f1tzo.com", Port= 5300, AuthKey= "FON-F1TZO" });
      builder.Entity<Channel>().HasData(new Channel { Id = 4, Name = "Salon Technique", CallSign = "(CH) HB9GXP2 H", Host = "rrf3.f5nlg.ovh", Port = 5301, AuthKey = "Magnifique123456789!" });
      builder.Entity<Channel>().HasData(new Channel { Id = 5, Name = "Salon International", CallSign = "(CH) HB9GXP2 H", Host = "rrf3.f5nlg.ovh", Port = 5302, AuthKey = "Magnifique123456789!" });
